...
const styles = StyleSheet.create({
  ...
  profileName: { color: theme.text, fontSize: 16, fontFamily: 'Poppins_900Black',
    fontWeight: '900' },
  profilePhone: { color: theme.textSecondary, fontSize: 11, fontFamily: 'Poppins_600SemiBold',
    fontWeight: '600' },
  rolePill: {
  ...
  roleText: { color: theme.primary, fontSize: 10, fontFamily: 'Poppins_900Black',
    fontWeight: '900' },
  menuRow: {
    minHeight: 52,
    backgroundColor: '#FFFFFF',
  ...
  menuTitle: { color: theme.text, fontSize: 12, fontFamily: 'Poppins_800ExtraBold',
    fontWeight: '800' },
  ...
  logoutText: { color: theme.danger, fontSize: 13, fontFamily: 'Poppins_900Black',
    fontWeight: '900' },
  formCard: {
    backgroundColor: '#FFFFFF',
    borderWidth: 1,
  ...
  formTitle: { color: theme.text, fontSize: 17, fontFamily: 'Poppins_900Black',
    fontWeight: '900' },
  formSubtitle: { color: theme.textSecondary, fontSize: 11, lineHeight: 17 },
  label: { color: theme.text, fontSize: 11, fontFamily: 'Poppins_800ExtraBold',
    fontWeight: '800' },
  input: {
    height: 50,
    borderWidth: 1,
  ...
  loginButtonText: { color: '#FFFFFF', fontSize: 13, fontFamily: 'Poppins_900Black',
    fontWeight: '900' },
